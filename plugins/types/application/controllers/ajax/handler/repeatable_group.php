...
class Types_Ajax_Handler_Repeatable_Group extends Toolset_Ajax_Handler_Abstract {
	...
	private function json_repeatable_group() {
		...
		// field conditions
		$conditions = $this->get_field_condtions_by_items( $items );
	...
	private function json_repeatable_group_add_item() {
		...
		// field conditions
		$conditions = $this->get_field_condtions_by_items( $new_item );
	 ...
	 * @return array
	 */
	private function get_field_condtions_by_items( &$items ){
		...
		return $form_condition->get_conditions();
	}
