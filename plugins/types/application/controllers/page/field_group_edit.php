	...
	private function build_strings_for_js() {
		return array(
			...
			'deleteFieldGroupWarning' => array(
				'singular' => __( 'If you delete the Field Group you will also delete the Relationship created in the existing Repeatable Group.<br /><br />Do you want to transform Field Group listed below into one-to-many Relationship?', 'wpcf' ),
				'plural' => __( 'If you delete the Field Group you will also delete the Relationships created in the existing Repeatable Groups.<br /><br />Do you want to transform Field Groups listed below into one-to-many Relationships?', 'wpcf' ),
			),
